...
\vspace{1 cm}
\uncover<5>{Without the non-linear activation functions, we'd lose this structure: linear transformations of linear transformations would collapse down to a single linear transformation.}
