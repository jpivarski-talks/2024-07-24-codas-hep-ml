...
\vspace{0.2 cm}
\mbox{Made extravagant claims; reality hit hard.\hspace{-1 cm}}
...
\begin{frame}{The ups and downs of AI: \only<1>{as mentioned in books}\only<2>{according to Henry Kautz}}
\vspace{0.2 cm}
\begin{columns}
\column{1.1\linewidth}
...
\begin{frame}{The ups and downs of AI: according to physicists at CHEP}
\vspace{0.25 cm}
